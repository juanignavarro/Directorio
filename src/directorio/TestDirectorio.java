...
public class TestDirectorio {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        directorio1.agregarCliente("2664124578", new Cliente(15878214,"Lorena","Ruiz","Buenos Aires","Libertad 1546"));
        */     
        /*
        tel1 = directorio1.buscarTeléfono("Ruiz");
        System.out.println("\nLOS NUMEROS DE TELEFONO CON ESE APELLIDO:");
        tel1.forEach(string -> {
        ...
        */
        ...
        /*
        tel2 = directorio1.buscarTeléfono("Ruiz");
        System.out.println("\nLOS NUMEROS DE TELEFONO CON ESE APELLIDO:");
        tel2.forEach(string -> {
            System.out.print(string+", ");
        });
